...
# GPIO
set_property -dict { PACKAGE_PIN C3    IOSTANDARD LVCMOS33 } [get_ports { sw[0] }]; # GPIO 0
...
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_a0 }]; # SRAM B Address 0
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_a1 }]; # SRAM B Address 1
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_a2 }]; # SRAM B Address 2
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_a3 }]; # SRAM B Address 3
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_a4 }]; # SRAM B Address 4
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_a5 }]; # SRAM B Address 5
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_a6 }]; # SRAM B Address 6
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_a7 }]; # SRAM B Address 7
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_a8 }]; # SRAM B Address 8
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_a9 }]; # SRAM B Address 9
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_a10 }]; # SRAM B Address 10
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_a11 }]; # SRAM B Address 11
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_a12 }]; # SRAM B Address 12
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_a13 }]; # SRAM B Address 13
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_a14 }]; # SRAM B Address 14
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_a15 }]; # SRAM B Address 15
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_a16 }]; # SRAM B Address 16
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_a17 }]; # SRAM B Address 17
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_a18 }]; # SRAM B Address 18
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_d0 }]; # SRAM B Data 0
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_d1 }]; # SRAM B Data 1
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_d2 }]; # SRAM B Data 2
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_d3 }]; # SRAM B Data 3
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_d4 }]; # SRAM B Data 4
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_d5 }]; # SRAM B Data 5
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_d6 }]; # SRAM B Data 6
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_d7 }]; # SRAM B Data 7
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_d8 }]; # SRAM B Data 8
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_d9 }]; # SRAM B Data 9
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_d10 }]; # SRAM B Data 10
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_d11 }]; # SRAM B Data 11
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_d12 }]; # SRAM B Data 12
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_d13 }]; # SRAM B Data 13
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_d14 }]; # SRAM B Data 14
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_d15 }]; # SRAM B Data 15
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_cen }]; # SRAM B chip enable
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_wen }]; # SRAM B write enable
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_oen }]; # SRAM B output enable
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_bhen }]; # SRAM B byte high enable
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { sramb_blen }]; # SRAM B byte low enable